...
/* Helper function that parses the inspector sexp.  It return a object with the
   ...
   printed as the UI, with id's corresponding to actions. */
...
Client.prototype.inspect_frame_var = function(frame_index, var_name, thread) {
  var cmd = "(SWANK:INSPECT-IN-FRAME " + to_lisp_string(var_name) + " " + frame_index +")";
